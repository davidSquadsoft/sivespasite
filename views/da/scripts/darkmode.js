...
const changeToDark = () => {
    ...
    colorsVar.style.setProperty('--green_button', 'linear-gradient(to right, #3c773c, #3c773c, #23437b)');
    ...
    document.getElementById("logosivespa").src = "../images/logo_horizontal.svg";
    document.getElementById("logoseccional").src = "../images/logo_seccional_salud_blanco.png";
...
const changeToNormal = () => {
    ...
    colorsVar.style.setProperty('--green_button', 'linear-gradient(to right, #3c773c, #3c773c, #61B8CF)');
    ...
    document.getElementById("logosivespa").src = "../images/logo_horizontal_mobile.svg";
    document.getElementById("logoseccional").src = "../images/logo_seccional_salud.png";
